...
export class Init1778141514354 implements MigrationInterface {
    name = 'Init1778141514354'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "kpi_data_entry" ("id" SERIAL NOT NULL, "kpi_definition_id" integer NOT NULL, "kpi_def_year" integer NOT NULL, "kpi_def_month" integer NOT NULL, "numerator_value" double precision NOT NULL, "denominator_value" double precision, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT timezone('Asia/Bangkok', now()), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT timezone('Asia/Bangkok', now()), CONSTRAINT "PK_b7358eebe4dbe469bb79512f010" PRIMARY KEY ("id"))`);
